...
INSERT INTO plot_theme (name, theme_type_id) VALUES ('Prieuré de Sion', (SELECT id FROM theme_type WHERE name = 'organisation'));
INSERT INTO plot_theme (name, theme_type_id) VALUES ('Illuminaten', (SELECT id FROM theme_type WHERE name = 'organisation'));
INSERT INTO plot_theme (name, theme_type_id) VALUES ('Templer', (SELECT id FROM theme_type WHERE name = 'organisation'));
...
INSERT INTO plot_theme (name, theme_type_id) VALUES ('Merowingische Blutlinie', (SELECT id FROM theme_type WHERE name = 'theory'));
