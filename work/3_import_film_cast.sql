INSERT INTO film_cast (name, work_role, film_role) VALUES 
...
('Ron Howard', 'Director', NULL),
('Brian Grazer', 'Producer', NULL),
('John Calley', 'Producer', NULL),
('Akiva Goldsman', 'Screenwriter', NULL),
('Dan Brown', 'Author', NULL),
('Tina Maskell', 'Actor', 'Mother of Silas'),
('Peter Pedrero', 'Actor', 'Father of Silas'),
...
('Christopher Fosh', 'Actor', 'Armed Response Police Officer (uncredited)'),
...
('Paul Herbert', 'Actor', 'Father of Sophie (uncredited)'),
...
('Arnold Montey', 'Actor', 'Armed Response Police Officer (uncredited)'),
...
('Andy Skinner', 'Actor', 'Armed Response Police Officer (uncredited)'),
...
('Hans Zimmer', 'Music by', NULL),
('Salvatore Totino', 'Cinematography by', NULL),
('Daniel P. Hanley', 'Editing by', NULL),
('Mike Hill', 'Editing by', NULL),
('Janet Hirshenson', 'Casting by', NULL),
('Jane Jenkins', 'Casting by', NULL);